"""
CREDIT: https://github.com/labay11/ideal-gas-simulation
...
class Simulation(animation.TimedAnimation):
    ...
    def init_figures(self):
        ...
        self.line_3d_cm = self.ax1.plot(
            [0], [0], [0], ls="None", marker=".", color="r"
        )[0]
    ...
    def _draw_frame(self, t):
        ...
        if i > self.last_P + 1:
            ...
            A_avg = (
                self.A
                if self.Vconst
                else (self.A + 6 * np.power(self.V(t - self.dP), 2 / 3)) / 2
            )
